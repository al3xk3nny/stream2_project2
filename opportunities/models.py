...
class Post(models.Model):
    ...
    author = models.ForeignKey(User, related_name='posts', null=False, blank=False, on_delete=models.PROTECT)
    image = models.ImageField(upload_to="images", default="images/no_image.png", null=True, blank=True)
...
class Message(models.Model):
    ...
    created_date = models.DateTimeField(auto_now_add=True)
    post = models.ForeignKey(Post, related_name='messages', null=False, blank=False, on_delete=models.CASCADE)
